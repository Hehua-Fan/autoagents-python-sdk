...
if __name__ == "__main__":
    ...
    result, chat_id = client.invoke(prompt="你好", chat_id="1584998")
    pprint(result)
    pprint(chat_id)
    history = client.get_chat_history(chat_id=chat_id, page_size=10, page_number=1)
    pprint(history)
    
    # print(result['choices'][0]['content'])